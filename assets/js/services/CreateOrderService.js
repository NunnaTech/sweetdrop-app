        ...
        cardProducts.innerHTML += `
             <div class="col-xl-4 col-lg-6 col-md-6">
                 <div class="card mb-3 bg-light">
                     <div class="row g-0">
                         <div  class="col-md-4 d-flex align-items-center justify-content-center pt-4 pb-1">
                         ...
                         <div class="col-md-8">
                             <div class="card-body">
                                 ...
                                 <p class="card-text text-auxiliar font-extrabold">${product.price}  MXN </p>
                                 <label class="font-bold"
                                     for="quantity">Cantidad:</label>
                                 <div class="input-group my-3">
                                     <button type="button" class="btn btn-secondary input-group-text btn-lg" onclick="minusProduct()"><i class="fas fa-minus"></i></button>
                                     <input type="number" min="0" value="0" min="1" max="99" class="form-control h-auto d-inline-block"/>
                                     <button type="button" class="btn btn-secondary input-group-text btn-lg"><i class="fas fa-plus"></i></button>
                                 </div>
...
function validateForm() {
    return comment.value !== "" && received_by.value !== "" && images.length !== 0 && products.length !== 0 && id !== "";
}
